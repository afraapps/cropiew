...
import ir.afraapps.widget.cropiew.CropImageView.RequestSizeOptions
import ir.afraapps.widget.cropiew.common.CommonVersionCheck.isAtLeastQ29
import ir.afraapps.widget.cropiew.utils.getUriForFile
...
internal object BitmapUtils {
    ...
    fun writeBitmapToUri(
        ...
        return (customOutputUri ?: buildUri(context, compressFormat))?.let { uri ->
            context.contentResolver.openOutputStream(uri, WRITE_AND_TRUNCATE)?.use {
